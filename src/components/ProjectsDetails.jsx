...
const ProjectsDetails = () => {
  ...
  return (
    <section className={styles.container}>
      ...
      <p>
        Space Travelers&apos; Hub is a react application for a company that
        deals with transporting people to space using rockets. This web
        application allows users to book rockets and join selected space
        missions. Also, users can cancel or leave joined mission at any time.
      ...
      <div className={styles.iconDiv}>
        ...
        <a href="https://github.com/tumainimaganiko/space-travelers">
          VIEW CODE
        </a>
      </div>
    </section>
